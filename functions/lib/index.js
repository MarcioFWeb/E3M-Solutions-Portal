    ...
    corsHandler(request, response, async () => {
        ...
        try {
          ...
          `,
            ...
            logger.info("Email enviado com sucesso", { id: data === null || data === void 0 ? void 0 : data.id });
            response.status(200).json({ success: true, id: data === null || data === void 0 ? void 0 : data.id });
        }
        catch (error) {
